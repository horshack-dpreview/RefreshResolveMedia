...
#############################################################################
#
# ReplaceWithOriginal_SelectedClips.py
...
dlg = createProcessingDialog("Replacing with originals on selected clips...")
rrm.refreshMedia("RefreshSelectedClips", "ReplaceWithOriginal")
