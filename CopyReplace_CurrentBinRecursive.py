...
#############################################################################
#
# CopyReplace_CurrentBinRecursive.py
...
dlg = createProcessingDialog("Copying+Replacing clips in current bin recursively...")
rrm.refreshMedia("RefreshCurrentBinRecursive", "CopyAndReplace")
