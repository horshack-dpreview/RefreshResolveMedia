...
#############################################################################
#
# ReplaceWithOriginal_CurrentBin.py
...
dlg = createProcessingDialog("Replacing with originals in current bin...")
rrm.refreshMedia("RefreshCurrentBin", "ReplaceWithOriginal")
